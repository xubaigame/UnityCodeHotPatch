...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Gun), GunWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Boss), BossWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(DeffendBoss), DeffendBossWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(InvisibleBoss), InvisibleBossWrap.__Register);
